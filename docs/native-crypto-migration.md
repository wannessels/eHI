...
See [performance configuration](performance.md) and [benchmark methodology](../benchmarks/README.md). The earlier [profiling report](performance-profiling.md) is a historical snapshot of the partial migration, not a measurement of this fully native implementation.
