...
| `ehealth.revocation.cache.entries`, `.bytes`, `ehealth.chain.cache.entries`, `ehealth.certificate.cache.entries` | observable gauges | | Cache sizes |
